...
namespace UI.ViewModels
{
    public class EncoderWindowVM : INotifyPropertyChanged
    {
        ...
        private RelayCommand<Grid> _toggleLockLogInfoCommand;
        public RelayCommand<Grid> ToggleLockLogInfoCommand
        {
            get
            {
                if (_toggleLockLogInfoCommand == null)
                {
                    _toggleLockLogInfoCommand = new((or) =>
                    {
                        var o = or.FindName("KeyTextBoxEx") as PasswordBox;
                        ...
                        {
                            foreach (var item in or.Children)
                            {
                                if (item is TextBoxEx tbe)
                                {
                                    tbe.GetBindingExpression(TextBoxEx.TextProperty)?.UpdateSource();
                                }
                            }
